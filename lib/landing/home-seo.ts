...
export const HOME_SEO: LocaleContent<HomeSeo> = {
  en: {
    ...
    links: [
      { label: "EVTX to XML", path: "/evtx-to-xml" },
      { label: "EVTX to CSV", path: "/evtx-to-csv" },
      { label: "EVTX to TXT", path: "/evtx-to-txt" },
      { label: "EVTX to JSON", path: "/evtx-to-json" },
      { label: "EVTX on Mac & Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump online", path: "/evtx-dump-online" },
  ...
  fr: {
    ...
    links: [
      { label: "EVTX en XML", path: "/evtx-to-xml" },
      { label: "EVTX en CSV", path: "/evtx-to-csv" },
      { label: "EVTX en TXT", path: "/evtx-to-txt" },
      { label: "EVTX en JSON", path: "/evtx-to-json" },
      { label: "EVTX sur Mac et Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump en ligne", path: "/evtx-dump-online" },
  ...
  de: {
    ...
    links: [
      { label: "EVTX in XML", path: "/evtx-to-xml" },
      { label: "EVTX in CSV", path: "/evtx-to-csv" },
      { label: "EVTX in TXT", path: "/evtx-to-txt" },
      { label: "EVTX in JSON", path: "/evtx-to-json" },
      { label: "EVTX auf Mac & Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump online", path: "/evtx-dump-online" },
  ...
  es: {
    ...
    links: [
      { label: "EVTX a XML", path: "/evtx-to-xml" },
      { label: "EVTX a CSV", path: "/evtx-to-csv" },
      { label: "EVTX a TXT", path: "/evtx-to-txt" },
      { label: "EVTX a JSON", path: "/evtx-to-json" },
      { label: "EVTX en Mac y Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump online", path: "/evtx-dump-online" },
  ...
  it: {
    ...
    links: [
      ...
      { label: "EVTX in TXT", path: "/evtx-to-txt" },
      { label: "EVTX in JSON", path: "/evtx-to-json" },
      { label: "EVTX su Mac e Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump online", path: "/evtx-dump-online" },
  ...
  pt: {
    ...
    links: [
      { label: "EVTX para XML", path: "/evtx-to-xml" },
      { label: "EVTX para CSV", path: "/evtx-to-csv" },
      { label: "EVTX para TXT", path: "/evtx-to-txt" },
      { label: "EVTX para JSON", path: "/evtx-to-json" },
      { label: "EVTX no Mac e Linux", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump online", path: "/evtx-dump-online" },
      { label: "Abrir Security.evtx", path: "/security-evtx" },
      { label: "Abrir System.evtx", path: "/system-evtx" },
  ...
  ja: {
    ...
    linksIntro: "さらに読む：",
    links: [
      { label: "EVTX を XML に変換", path: "/evtx-to-xml" },
      { label: "EVTX を CSV に変換", path: "/evtx-to-csv" },
      { label: "EVTX を TXT に変換", path: "/evtx-to-txt" },
      { label: "EVTX を JSON に変換", path: "/evtx-to-json" },
      { label: "Mac・Linux で EVTX を開く", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump オンライン", path: "/evtx-dump-online" },
  ...
  zh: {
    ...
    linksIntro: "继续阅读：",
    links: [
      { label: "EVTX 转 XML", path: "/evtx-to-xml" },
      { label: "EVTX 转 CSV", path: "/evtx-to-csv" },
      { label: "EVTX 转 TXT", path: "/evtx-to-txt" },
      { label: "EVTX 转 JSON", path: "/evtx-to-json" },
      { label: "在 Mac 和 Linux 上打开 EVTX", path: "/evtx-viewer-mac-linux" },
      { label: "evtx_dump 在线版", path: "/evtx-dump-online" },
