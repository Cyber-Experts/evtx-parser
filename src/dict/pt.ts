...
export const pt: Dict = {
  ...
  home: {
    ...
    heroTag: "Código aberto · 100% no seu navegador",
    heroCtaOpen: "Abrir um arquivo .evtx",
    heroCtaGithub: "Ver no GitHub",
    footerTagline: "Forense de logs de eventos do Windows, inteiramente no seu navegador.",
    statHunts: "regras de hunting integradas",
    statUploaded: "bytes enviados",
    statEngine: "parser compilado para WebAssembly",
    statLocales: "idiomas",
    worksWith: "Lê todos os canais que você coleta",
    featuresEyebrow: "Feito para resposta a incidentes",
    featuresHeading: "Do .evtx bruto a achados em minutos",
    featuresIntro: "Tudo o que um analista DFIR precisa, sem instalar o Visualizador de Eventos, Python ou um SIEM.",
    ...
    features: [
      ...
      { title: "Notas e relatório Markdown", body: "Marque e anote eventos, exporte um relatório limpo ou compartilhe uma visão filtrada por link." },
      { title: "Offline e open source", body: "Roda isolado no Docker, Elastic License 2.0, parser em Rust auditável no GitHub." },
    ],
  ...
  viewer: {
    ...
    eventsTab: "Eventos",
    sessionsTab: "Sessões de logon",
    sessionsHint: "Uma linha por logon, tokens UAC mesclados. Clique numa sessão para ver todos os seus eventos.",
    sessionStart: "Logon",
    sessionEnd: "Logoff",
    sessionDuration: "Duração",
    sessionUser: "Conta",
    sessionType: "Tipo de logon",
    sessionSource: "Origem",
    sessionAdmin: "Admin",
    sessionEvents: "Eventos",
    sessionActivity: "Atividade",
    sessionOpen: "ainda aberta",
    sessionUnknownStart: "antes do início do log",
    showSystemSessions: "Mostrar sessões de sistema e de serviço",
    noSessions: "Nenhuma sessão de logon nos logs carregados — as sessões são construídas a partir de eventos Security 4624.",
    filesLabel: "arquivos",
    fileLabel: "arquivo",
    showFiles: "Mostrar arquivos",
    hideFiles: "Ocultar arquivos",
    showControls: "Mostrar achados e linha do tempo",
    hideControls: "Ocultar achados e linha do tempo",
    rangeTitle: "Intervalo de tempo",
    rangeFrom: "De",
    rangeTo: "Até",
    rangeApply: "Aplicar",
    rangeInvalid: "O início deve ser antes do fim",
    pinColumn: "Fixar coluna",
    unpinColumn: "Desafixar coluna",
    resizeColumn: "Arraste para redimensionar · clique duplo para ajustar ao conteúdo",
    resetColumns: "Redefinir colunas",
    saveSession: "Salvar sessão",
    sessionSaved: "Sessão salva",
    savingSession: "Salvando…",
    savedSessionsTitle: "Sessões salvas neste dispositivo",
    savedSessionsHint: "Guardadas apenas neste navegador (IndexedDB) — nada é enviado. Continue de onde parou ou exclua-as.",
    resumeSession: "Retomar",
    deleteSession: "Excluir",
    confirmDeleteSession: "Excluir esta sessão salva? Apenas a cópia armazenada neste navegador é removida — seus arquivos no disco não são afetados.",
    cancel: "Cancelar",
    sessionName: "Nome da sessão",
    saveSessionTitle: "Salvar esta sessão",
    saveSessionDescription: "Guardada apenas neste navegador — nada é enviado. Depois de salva, suas alterações são salvas automaticamente.",
    renameSessionTitle: "Renomear sessão",
    renameSession: "Renomear",
    saveAction: "Salvar",
    deleteSessionTitle: "Excluir a sessão salva?",
    restoringSession: "Restaurando a sessão…",
    storageFull: "Armazenamento do navegador insuficiente para salvar estes arquivos.",
    autoSaved: "Salvo automaticamente",
    autoSaveHint: "Salva neste navegador — as alterações são salvas automaticamente. Clique para salvar agora.",
