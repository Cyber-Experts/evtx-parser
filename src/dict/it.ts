...
export const it: Dict = {
  ...
  home: {
    ...
    heroTag: "Open source · 100% nel tuo browser",
    heroCtaOpen: "Apri un file .evtx",
    heroCtaGithub: "Vedi su GitHub",
    footerTagline: "Analisi forense dei log eventi di Windows, interamente nel browser.",
    statHunts: "regole di hunting integrate",
    statUploaded: "byte caricati",
    statEngine: "parser compilato in WebAssembly",
    statLocales: "lingue",
    worksWith: "Legge ogni canale che raccogli",
    featuresEyebrow: "Pensato per l'incident response",
    featuresHeading: "Dal .evtx grezzo ai risultati in pochi minuti",
    featuresIntro: "Tutto ciò che serve a un analista DFIR, senza installare Visualizzatore eventi, Python o un SIEM.",
    ...
    features: [
      ...
      { title: "Note e report Markdown", body: "Segna e annota eventi, esporta un report pulito o condividi una vista filtrata tramite link." },
      { title: "Offline e open source", body: "Funziona air-gapped in Docker, Elastic License 2.0, parser Rust verificabile su GitHub." },
    ],
