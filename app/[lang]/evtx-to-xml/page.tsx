...
import { EVTX_TO_XML, type EvtxToXml } from "@/lib/landing/evtx-to-xml";
...
export async function generateMetadata({
  ...
  const c = pickLocale(EVTX_TO_XML, locale);
...
function buildGraph(locale: Locale, url: string, c: EvtxToXml, siteName: string) {
  return {
...
export default async function EvtxToXmlPage({
  params,
}: {
  params: Promise<{ lang: string }>;
}) {
